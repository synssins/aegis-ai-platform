...
| 8 | ComfyUI (image generation) — **shipped 2026-09-24** behind prompt / file / output gates, gallery with self-purge, admin review switch | Remaining: input-image (upload) gate, per-user quotas, automatic model unload when VRAM is short (design 4b) |
