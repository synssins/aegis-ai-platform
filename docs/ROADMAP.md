...
| 4 | Llama Guard 8B on the Intel Arc cards — **runtime proven 2026-09-24:** stock Ollama image, Vulkan backend, 45 tok/s on one B60 (design: `docs/designs/gpu-runtime-and-scheduling.md`) | Phase 1 of the design: add the `ollama-intel` pool, pin the guard to it, sentinel phase 3 green |
